...
const Song = () => {
    ...
    const { image, name, duration, artist, audio } = songsArray.filter((currentSongObj) => currentSongObj._id === id)[0];  // pega apenas o primeiro elemento da lista
        ...
        <div className="song">
            ...
            <div className="song__bar">
                <Link to={`/artist/${artistObj._id}`} className="song__artist-image">
                    ...
                    width={75}
                    height={75}
                    src={artistObj.image} alt={`Imagem da Música ${artist}`} />
                </Link>
